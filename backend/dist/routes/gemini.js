...
const PROMPT = `You are a toy classifier. Analyze the provided image and text description of a children's toy. Output ONLY valid JSON with these exact keys, selecting ONE option per category from the allowed values. Do not add extra fields, explanations, or markdown.
...
router.post('/classify', express_1.default.json({ limit: '20mb' }), async (req, res) => {
    try {
