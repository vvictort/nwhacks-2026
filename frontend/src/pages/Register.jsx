            ...
            >
                <NeuCard className="text-center relative overflow-visible">
                    <div className="mb-8">
                        ...
                        <p className="text-neo-bg-600 text-lg">
                            Let's share toys and spread smiles worldwide! 🌍✨
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            {formData.password && (
                                <div className="mt-2 ml-4">
                                    ...
                                    <p className="text-xs text-neo-bg-500">
                        ...
                        <div>
                            <div className="flex items-start gap-3 mt-2">
                                ...
                                <label htmlFor="terms" className="text-sm text-neo-bg-600 text-left flex-1">
                                    ...
                                    <Link
                                        to="/terms"
                                        className="text-neo-primary-700 font-semibold hover:underline"
                                    >
                                        Terms of Use
                                    </Link>{" "}
                                    and{" "}
